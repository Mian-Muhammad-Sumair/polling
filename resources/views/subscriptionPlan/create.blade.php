            ...
            <div class="col-md-12 col-sm-12 col-lg-12">
                <div class="col-md-12 col-sm-12">
                    <div class="col-md-12 main">
                        <h2 class="title-page">Create Plan</h2>
                        <div class="theme-bar"></div>
                    </div>
                    <form method="post" action="{{ url("/admin/subscription_plan") }}">
                        @csrf
                        @method('post')
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="select-dropdown">
                                    <select name="plan_type" >
                                        ...
                                        <option class="option-item" value="Day" {{'Day'==old('plan_type')?'selected':''}}>
                                            Day
                                        </option>
                                        <option class="option-item" value="Week" {{'Week'==old('plan_type')?'selected':''}}>
                                            Week
                                        </option>
                                        <option class="option-item" value="Month"  {{'Month'==old('plan_type')?'selected':''}}>
                                            Month
                                        </option>
                                        <option class="option-item" value="Year"  {{'Year'==old('plan_type')?'selected':''}}>
                                            Year
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="number" name="plan_value"
                                       value="{{old('plan_value') }}">
                        ...
                        <div class="col-md-4 col-sm-4 col-lg-4">
                            <input type="submit" class="custom-btn-update " name="status" value="Submit">
                        </div>
                    </form>
                </div>
            </div>
